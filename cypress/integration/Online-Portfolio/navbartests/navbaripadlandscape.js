describe('Portfolio Navbar Tests for iPad Landscape', () => {
    beforeEach(function() {
    ...
    it('Check that the Work link on the Navbar goes to the Work page', function() {
        ...
        cy.percySnapshot('WorkiPadlandscape')
    })
